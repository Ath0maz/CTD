...
/* 
Crie outra estrutura semelhante à primeira, mas com os seguintes 
filmes de animação:
 */
...
function add(filmesSeries, filmesAnimados) {
    let arrayFilmes = filmesSeries.concat(filmesAnimados)
    console.log(arrayFilmes)
}

add(filmesSeries, filmesAnimados)
...
/* Durante o processo, percebemos que o último elemento na série de filmes animados é,
 ...
 remover o último elemento antes de migrar o conteúdo para
  o array que contém todos os filmes.
 */
...
mundo nos filmes com o seguinte formato: Crie uma função que compare as notas e nos diga
...
euroScores.filter(function (element) {
    if (asiaScores.indexOf(element) !== -1) {
        pontuacao.push(element)
    }
})
